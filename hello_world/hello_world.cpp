...
int main() {
    ...
    std::ifstream hello_world_file( "../../hello_world/hello_world.cl" );
    ...
    if ( err != CL_BUILD_SUCCESS ) {
        std::cerr << "Build Status: " << program.getBuildInfo< CL_PROGRAM_BUILD_STATUS >( device ) << "Build Log:\t " << program.getBuildInfo< CL_PROGRAM_BUILD_LOG >( device ) << std::endl;
        exit( 1 );
    }
